...
return redirect('corseSelect');
  ...
  public function insertCorse(Request $req)
  {
  ...
  public function insertStudy(Request $req)
 {
    $stdId = $req->input('std');
 ...
 public function selectStdClass ()
 {
 ...
 public function insertClassRecord(Request $r)
 {
  ...
  public function insStdReport(Request $req)
 {
   ...
   $getCorse = DB::table('corse')->where('corse_id','=', $datas)->get();//ดึงชื่อคอร์ส
